...
PRODUCTOS = [
    ...
    ("Amonio cuaternario 5ta generación", "Desinfectantes y sanitizantes", "Poett", "Galón 4L", "en_stock", True,
     "Desinfectante hospitalario de amplio espectro. Concentración 1:200.", 65.00),
    ("Hipoclorito de sodio 7.5%", "Desinfectantes y sanitizantes", "Marsella", "Bidón 20L", "en_stock", False,
     "Lejía industrial estabilizada para desinfección de superficies y aguas.", 78.00),
    ("Alcohol etílico 70° desnaturalizado", "Desinfectantes y sanitizantes", "Dkasa", "Galón 4L", "en_stock", False,
     "Sanitizante de manos y superficies. Listo para usar.", 42.00),
    ("Peróxido de hidrógeno estabilizado", "Desinfectantes y sanitizantes", "Daryza", "Bidón 5L", "bajo_pedido", False,
    ...
    ("Aromatizador desinfectante para inodoros", "Productos para baño", "Daryza", "Galón 4L", "en_stock", False,
     "Doble acción: aromatiza y desinfecta. Disponible en pino, lavanda y cítrico.", 52.00),
    ("Limpiador urinario concentrado", "Productos para baño", "Poett", "Galón 4L", "en_stock", False,
     "Elimina manchas y olores de urinarios. Fórmula tensoactiva concentrada.", 49.00),

    ("Cera líquida abrillantadora", "Pisos y superficies", "Dkasa", "Galón 4L", "en_stock", True,
     "Acabado mate-brillante para pisos vinílicos y cerámicos. Alto rendimiento.", 72.00),
    ("Decapante para pisos", "Pisos y superficies", "Marsella", "Galón 4L", "en_stock", False,
    ...
    ("Toalla de manos en Z doble hoja", "Papel y descartables", "Dkasa", "Caja 20 paquetes x 200u", "en_stock", False,
     "Para dispensador Z, alta absorción, ideal para baños corporativos.", 145.00),
    ("Guantes de nitrilo descartables", "Papel y descartables", "Poett", "Caja 100u talla M", "en_stock", False,
    ...
    ("Aspiradora industrial polvo-líquido 30L", "Equipos y maquinaria", "Marsella", "Unidad 1400W", "en_stock", True,
     "Tanque 30L acero inoxidable, succión 2200mm H₂O, ideal para hoteles e industria.", 1450.00),
    ("Hidrolavadora profesional 150 bar", "Equipos y maquinaria", "Dkasa", "Unidad 2300W", "bajo_pedido", False,
